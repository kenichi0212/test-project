...
<?php $component->withAttributes([]); ?>
    ...
    <div class="mx-auto max-w-7xl px-6">
        ...
        <?php endif; ?>
        <form method="post" action="<?php echo e(route('post.update', $post)); ?>">
            <?php echo csrf_field(); ?>
...
<?php endif; ?>
                    <input type="text" name="title" class="w-auto rounded-md border border-gray-300 py-2"
                        id="title" value="<?php echo e(old('title', $post->title)); ?>">
                </div>
            </div>
...
<?php endif; ?>
                <textarea name="body" class="w-auto rounded-md border border-gray-300 py-2" id="body" cols="30"
                    rows="5"><?php echo e(old('body', $post->body)); ?></textarea>
            </div>
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/post/edit.blade.php ENDPATH**/ ?>