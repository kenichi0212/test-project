...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.message','data' => ['message' => session('message')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                <textarea name="body" class="w-full rounded-md border border-gray-300 px-3 py-2" id="body" cols="30"
                    rows="5" required><?php echo e(old('body')); ?></textarea>
            </div>
